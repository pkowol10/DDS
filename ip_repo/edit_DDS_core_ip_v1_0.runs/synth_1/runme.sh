...
HD_PWD='c:/users/pkowo/desktop/studia/systemydedykowane/projekt/ip_repo/edit_DDS_core_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_core_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_core_ip_v1_0.tcl
